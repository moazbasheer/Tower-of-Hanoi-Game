    ...
    , ui(new Ui::MainWindow)
{
    ...
    first=-1;
    second=-1;
    OrderedData.push_back("C:/Users/pc/Documents/TowerOfHanoi/images/untitled4.png");
    OrderedData.push_back("C:/Users/pc/Documents/TowerOfHanoi/images/untitled3.png");
    OrderedData.push_back("C:/Users/pc/Documents/TowerOfHanoi/images/untitled2.png");
    OrderedData.push_back("C:/Users/pc/Documents/TowerOfHanoi/images/untitled5.png");
...
bool MainWindow::isWon(){
    if((int)C.size()!=Difficulty) return false;
    for(int i=0;i<Difficulty;i++){
        if(C[i]!=OrderedData[i]) return false;
    }
    return true;
}
...
bool MainWindow::IsSmaller(string s1,string s2){
    ...
    for(int i=0;i<(int)OrderedData.size();i++){
        if(OrderedData[i]==s1) index1=i;
    }
    for(int i=0;i<(int)OrderedData.size();i++){
        if(OrderedData[i]==s2) index2=i;
    }
    return index1>index2;
}
bool MainWindow::isValid(){
    string s1,s2;
    if(first==1) s1=A.back();
    if(first==2) s1=B.back();
    if(first==3) s1=C.back();
    if(second==1){
